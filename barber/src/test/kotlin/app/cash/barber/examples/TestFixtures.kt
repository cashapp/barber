...
val investmentPurchasePlaintextSmsDocumentTemplateEN_US = DocumentTemplate(
    fields = mapOf(
        "no_annotation_field" to "You purchased {{ shares }} of {{ ticker }}.",
        "default_field" to "You purchased {{ shares }} of {{ ticker }}.",
        "html_field" to "You purchased {{ shares }} of {{ ticker }}.",
        "plaintext_field" to "You purchased {{ shares }} of {{ ticker }}."
    ),
